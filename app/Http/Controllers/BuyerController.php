...
class BuyerController extends Controller implements HasMiddleware
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data buyer has been successfully retrieved', BuyerResource::collection($buyers), 200);
        } catch (\Exception $e) {
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data buyer has been successfully retrieved', PaginateResource::make($buyers, BuyerResource::class), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function store(BuyerStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data buyer has been created', new BuyerResource($buyer), 201);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            if(!$buyer) {
                return ResponseHelper::jsonResponse(true, 'Data buyer not found', null, 404);
            }
            return ResponseHelper::jsonResponse(true, 'Data buyer has been found', new BuyerResource($buyer), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function update(BuyerUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data buyer has been updated', new BuyerResource($buyer), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data buyer has been deleted', new BuyerResource($buyer), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
