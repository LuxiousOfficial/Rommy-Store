...
class ProductCategoryController extends Controller implements HasMiddleware
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data product category has been successfully retrieved', ProductCategoryResource::collection($productCategories), 200);
        } catch (\Exception $e) {
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data product category has been successfully retrieved', PaginateResource::make($productCategories, ProductCategoryResource::class), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function store(ProductCategoryStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data product category has been created', new ProductCategoryResource($productCategory), 201);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function show(string $id)
    {
        try {
            ...
            if(!$productCategory) {
                return ResponseHelper::jsonResponse(true, 'Data product category not found', null, 404);
            }
            return ResponseHelper::jsonResponse(true, 'Data product category has been found', new ProductCategoryResource($productCategory), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function update(ProductCategoryUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data product category has been updated', new ProductCategoryResource($productCategory), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data product category has been deleted', new ProductCategoryResource($productCategory), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
